...
/** Set path and size for TempDB files **
ALTER DATABASE [tempdb] MODIFY FILE ( NAME = N'tempdev', FILENAME = N'G:\SQLTemp\tempdb.mdf', SIZE = 12375MB, FILEGROWTH = 1024MB)

ALTER DATABASE [tempdb] MODIFY FILE ( NAME = N'temp2', FILENAME = N'G:\SQLTemp\tempdb_mssql_2.ndf', SIZE = 12375MB, FILEGROWTH = 1024MB )

ALTER DATABASE [tempdb] MODIFY FILE ( NAME = N'temp3', FILENAME = N'G:\SQLTemp\tempdb_mssql_3.ndf', SIZE = 12375MB, FILEGROWTH = 1024MB )

ALTER DATABASE [tempdb] MODIFY FILE ( NAME = N'temp4', FILENAME = N'G:\SQLTemp\tempdb_mssql_4.ndf', SIZE = 12375MB, FILEGROWTH = 1024MB )

ALTER DATABASE [tempdb] MODIFY FILE ( NAME = N'templog', FILENAME = N'H:\SQLLOGS\templog.ldf' SIZE = 12375MB, FILEGROWTH = 1024MB)

/** Set file size and growth for the ReportServer database **
ALTER DATABASE [reportserver] MODIFY FILE ( NAME = N'reportserver', SIZE = 51200MB, FILEGROWTH = 1024MB )

--set size of ReportServer db log file
ALTER DATABASE [reportserver] MODIFY FILE ( NAME = N'reportserver_log', SIZE = 4096MB, MAXSIZE = 10240MB, FILEGROWTH = 1024MB )

--set size of ReportServerTempDB
ALTER DATABASE [reportservertempdb] MODIFY FILE ( NAME = N'reportservertempdb', SIZE = 512MB, FILEGROWTH = 512MB )

--set size of ReportServerTempDB log file
ALTER DATABASE [reportservertempdb] MODIFY FILE ( NAME = N'reportservertempdb_log', SIZE = 256MB, MAXSIZE = 10240MB, FILEGROWTH = 256MB )
**/
...
************************************************************************************************************************/
DECLARE  @CMSiteCode  nchar(3) = N'PE1' -- This is the Site Code you are going to use for this CM Site.
...
/************************************************************************************************************************
    ...
    @LogFileGrowth       : This is where you control how to grow your log file when it needs more space. The default growth size
                           ...
                           The default is to grow the data files by 1 GB.
************************************************************************************************************************/
DECLARE  @NumTotalDataFiles   tinyint = 2
        ,@SecondDataDrive     nchar(1) = N''
        ,@InitialDataFileSize nvarchar(50) = N'75000MB' 
        ,@InitialLogFileSize  nvarchar(50) = N'37500MB'
